        ...
        <div class="mx-auto max-w-xl lg:max-w-screen-xl">
            <div class="mb-16 text-center lg:mb-0 lg:max-w-lg lg:text-left">
                <div class="mb-6 max-w-xl">
                    <div>
                        <p
                            class="bg-teal-accent-400 mb-4 inline-block rounded-full bg-green-200 px-3 py-px text-sm font-semibold tracking-wider text-green-900">
                            This is a mini Vue.js project</p>
                    </div>
                    <h2
                        ...
                        for
                        <span class="inline-block text-green-500">Meals Recipe</span>
                    </h2>
                    <p class="text-base text-gray-700 md:text-lg">Discover delicious and healthy recipes for every occasion
                        on our
                        easy-to-use meal recipe application.</p>
                </div>
                <div
                    class="flex flex-col items-center justify-center space-y-2 sm:flex-row sm:space-y-0 sm:space-x-2 lg:justify-start">
                    <a href="/"
                        class="inline-flex h-12 w-full items-center justify-center rounded-full border-2 border-green-500 px-4 font-semibold text-green-600 transition-colors duration-200 hover:border-y-green-400 hover:text-green-400 sm:w-auto">Watch
                        a demo video</a>
                </div>
